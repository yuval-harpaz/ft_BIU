...
% FIXED FOR BIU TRIGGER - avi 11/11/10
%
% TODO
...
% FIX for BIU TRIGGER
if isfield(hdr, 'orig') && isfield(hdr.orig, 'config_data') && strcmp(hdr.orig.config_data.site_name, 'Bar Ilan') && (chanindx == match_str(hdr.label, 'TRIGGER')),
    fixBIU=1;
else fixBIU=0;
end
