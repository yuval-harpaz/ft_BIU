...
% Changed by AA because of bug with channel indexing 12 Apr 2011
...
%      repair(k,l) = 1/distance; AA
      repair(k, match_str(data.label, sens.label{l})) = 1/distance; % AA
      fprintf('  using neighbour %s distance %d\n', sens.label{l},distance);
    end
  end
...
%   figure
%   plot(interp.trial{1,i}(248,:));
%   figure;
%   plot(data.trial{1,i}(248,:));
%   figure
%   plot(interp.trial{1,i}(40,:));
%   figure
%   plot(data.trial{1,i}(40,:));
