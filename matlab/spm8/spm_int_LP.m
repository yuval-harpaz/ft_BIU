...
% Karl Friston
% $Id: spm_int_LP.m 2353 2008-10-17 11:56:15Z karl $
...
for i = 1:ns
    ...
    %----------------------------------------------------------------------
    dfdp  = spm_diff(f,x,u,P,M,3);
    for j = 1:N
        x    = x    + Q*spm_vec(f(x,u,P,M));
        dxdp = dxdp + Q*dfdp;
    end
