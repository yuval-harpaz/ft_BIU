...
%
% $Id: ft_artifact_threshold.m 5343 2012-02-29 16:15:32Z roevdmei $

revision = '$Id: ft_artifact_threshold.m 5343 2012-02-29 16:15:32Z roevdmei $';
...
for trlop = 1:numtrl
  ...
  dat = preproc(dat, channel, offset2time(cfg.trl(trlop,3), hdr.Fs, size(dat,2)), artfctdef, cfg.trl(trlop,3));
