 ...
 * $Id: dacq_MotifInc.h 4702 2011-11-10 09:23:27Z borreu $
 */
...
/* xremote_clients.c */
extern int dacq_remote_no_wait_command(Widget w, int *sock, char *command, Dacq_async_finish finish);
/* xclient_socket.c */
extern int dacq_connect_xclient(XtAppContext ac, int *sock, int id);
