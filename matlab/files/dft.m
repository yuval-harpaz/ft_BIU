function [filt,est] = dft(dat, Fs, Fl)
...
%
% $Id: ft_preproc_dftfilter.m 7709 2013-03-28 10:54:18Z jansch $
...
if n == 0
    warning('better include a whole cycle (100ms for 10Hz estimate)')
    n05   = round(floor(nsamples .* Fl./Fs) * Fs./Fl);
    sel=1:nsamples;
end
