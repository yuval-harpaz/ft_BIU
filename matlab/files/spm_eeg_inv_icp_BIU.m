function [M1] = spm_eeg_inv_icp_BIU(data1,data2,fid1,fid2,Fmri,Fhsp,aff,nRot)
...
% nRot used to be 64, changed by yuval to 5 prevent too much rotation, feb 2012
% aff was changed from 2 to 1 to allow 
%--------------------------------------------------------------------------
